...
def check_hgt(height_field) -> bool:
    m1 = re.match(r'^(\d+)(cm|in)$', height_field)
    if m1:
        return ((m1[2] == 'cm' and 150 <= int(m1[1]) <= 193) or
...
def main() -> int:
    ...
    with open(args.data_file) as f, measure_time("day4:part2"):
